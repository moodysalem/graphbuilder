...
/**
 * Provides schema dynamically based on the injected construction counter. Does not change as
 * additional queries are executed because the SchemaBundle is constructed exactly once.
 */
public class DynamicSchemaModuleSingleton extends AbstractModule {
